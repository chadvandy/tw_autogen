...
--- Creates and returns a new advice manager. Client scripts do not need to call this, however by doing so they will be able to set it into debug mode for more output with advice_manager:set_debug, or disable advice with advice_manager:set_advice_enabled.
---@param debug_mode boolean? #optional, default value=false debug mode
...
function advice_manager:set_advice_enabled(enable_advice) end
...
---@param infotext table? #optional, default value=nil Table of infotext keys to show alongside the advice.
...
---@param can_interrupt boolean? #optional, default value=true can interrupt
...
---@param dont_trigger_advice boolean? #optional, default value=false If set to true, this monitor will trigger the callback but will not trigger the supplied advice or infotext itself. Set this to true if the callback takes care of triggering the advice itself.
...
---@param halt_on_end boolean? #optional, default value=true halt on end
...
---@param event string? #optional, default value=nil Event to test.
