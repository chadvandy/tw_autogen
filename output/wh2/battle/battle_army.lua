...
---@param position battle_vector? #optional, default value=nil Position at which the ability is targeted, if applicable.
---@param bearing number? #optional, default value=0 Bearing in radians of special ability, if applicable.
---@param width number? #optional, default value=0 Width of special ability, if applicable.
