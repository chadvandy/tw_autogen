...
---@return boolean #is ambush controller active 
...
---@param stop_instantly boolean? #optional, default value=false stop instantly
...
---@return boolean #camera is playing 
...
---@param starting_angle number? #optional, default value=nil Starting angle. If no angle is specified the camera's current facing is used instead (this is recommended).
---@param linear_movement boolean? #optional, default value=false Linear movement style. If enabled the camera will turn with a constantly velocity. If disabled the rate of camera rotation will accelerate and then decelerate.
---@param target_fov number? #optional, default value=0 Field of view at the end of the transition. If set to 0 the default field of view will be used, and if set to negative the current field of view will be kept.
...
---@param transition_time number #Transition time in seconds. Supply a negative number to have the function determine an appropriate transition time.
---@param linear_movement boolean? #optional, default value=false Linear movement style. If enabled the camera will move with a constantly velocity. If disabled the camera will accelerate and then decelerate.
---@param target_fov number? #optional, default value=0 Field of view at the end of the transition. If set to 0 the default field of view will be used, and if set to negative the current field of view will be kept.
---@param use_command_queue boolean? #optional, default value=true Setting this to false allows the camera to start moving when the game is paused, but the camera movement will not appear in replays. 
...
---@return battle_vector #target 
function battle_camera:target() end

--- Enables some functionality of the camera after it has been disabled with camera:disable_functionality.
---@param functionality string #Functionality to enable - see the list of valid functionality strings given above.
function battle_camera:enable_functionality(functionality) end

--- Disables some camera functionality.
---@param functionality string #Functionality to disable - see the list of valid functionality strings given above.
function battle_camera:disable_functionality(functionality) end

--- Changes the depth of field of the camera.
---@param transition_duration number #Transition duration in seconds.
---@param focus_distance number? #optional, default value=nil Focus distance. If this is not specified then the default focus distance is used.
---@param focal_length number? #optional, default value=nil Focal length. This must be specified if focus distance is supplied.
---@param blur_size number? #optional, default value=nil Blur size. This must be specified if focus distance is supplied.
function battle_camera:change_depth_of_field(transition_duration, focus_distance, focal_length, blur_size) end
...
---@param transition_duration number #Transition duration in seconds.
function battle_camera:fade(to_black, transition_duration) end
