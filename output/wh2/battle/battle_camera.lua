...
---@param focus_distance number Focus distance. If this is not specified then the default focus distance is used.
---@param focal_length number Focal length. This must be specified if focus distance is supplied.
---@param blur_size number Blur size. This must be specified if focus distance is supplied.
