...
---@param sposition battle_vector Start position.
---@param eposition battle_vector End position.
---@param duration number Duration for which to display the line, in seconds.
function battle_debug_drawing:draw_white_line_on_terrain(sposition, eposition, duration) end
...
---@param duration number Duration for which to display the line, in seconds.
---@param colour battle_colour Line colour.
function battle_debug_drawing:draw_line_on_terrain(sposition, eposition, duration, colour) end
