...
---@param update_ui boolean? #optional, default value=true Update UI with invisibility change. Supply false to not update the UI with this visibility change - only do this in very specific circumstances.
