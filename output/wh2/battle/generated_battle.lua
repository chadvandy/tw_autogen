...
---@param marker_type number Marker type. See the documentation for battle:add_ping_icon for a list of valid values.
...
---@param start_message string Start message which begins the wait time countdown.
...
function generated_army:get_shattered_proportion() end
...
function generated_army:reinforce_on_message(message, wait_offset) end
...
---@param position battle_vector Position to trigger special ability with, if applicable.
---@param orientation number Orientation to trigger special ability with, if applicable. This is specified in radians.
---@param width number Width in m to trigger special ability with, if applicable.
---@param delay number Delay in ms to wait after receiving the message before triggering the ability.
...
function generated_army:deploy_at_random_intervals_on_message(message, min_units, max_units, min_period, max_period, cancel_message, spawn_immediately) end
...
function generated_army:message_on_rout_proportion(message, threshold) end
...
---@param message string Message to trigger.
---@param threshold number Unary threshold (0 - 1).
function generated_army:message_on_shattered_proportion(message, threshold) end
