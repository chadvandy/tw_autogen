...
---@param debug_mode boolean? #optional, default value=false Activate debug mode, for more output.
...
---@param should_reorder boolean? #optional, default value=true should reorder
...
---@param completion_callback function? #optional, default value=nil Function to call when the patrol is completed.
...
---@param perform_proximity_test boolean? #optional, default value=true perform proximity test
