...
---@param index image Index of image associated with this uicomponent to overwrite the path of. This takes precedence over any set "script_icon_index" property.
...
---@param index image Index of image to return the path of.
