...
---@param send_metrics_data boolean? #optional, default value=false Send performance data to metrics.
...
function campaign_cutscene:cindy_playback(filepath, blend_in_duration, blend_out_duration) end
