...
---@param should_suppress boolean? #optional, default value=false should suppress
...
---@param marker_type string? #optional, default value=nil Marker type.
---@param x_offset number? #optional, default value=0 X offset.
---@param y_offset number? #optional, default value=0 Y offset.
---@param height_offset number? #optional, default value=0 Height offset.
...
---@param settlement_name string #Full settlement name. This is generally "settlement:" concatenated with the region key.
---@param is_marker boolean? #optional, default value=false Is marker. If set to true this removes a marker at the settlement - set this if a marker type was specified to campaign_ui_manager:highlight_settlement. If set to false then a vfx is removed - set this if no marker type was specified to campaign_ui_manager:highlight_settlement.
...
---@param show_highlight boolean? #optional, default value=false Show highlight.
---@param marker_type string? #optional, default value=nil Marker type to be supplied to campaign_ui_manager:highlight_settlement or campaign_ui_manager:unhighlight_settlement - see the documentation for those functions for more information.
...
---@param condition function? #optional, default value=nil Filter condition. If supplied, this should be a function which accepts a settlement object as a single argument and returns a boolean result. If the boolean result evaluates to true then the settlement is highlighted. The filter is only considered when highlighting - when unhighlighting, all settlements within the radius are unhighlighted regardless of any filter.
...
---@param character_object CHARACTER_SCRIPT_INTERFACE #Character object.
---@param is_marker boolean? #optional, default value=false Is marker. If set to true this removes a marker at the character - set this if a marker type was specified to campaign_ui_manager:highlight_character. If set to false then a vfx is removed - set this if no marker type was specified to campaign_ui_manager:highlight_character.
...
---@param faction_key string #faction key
---@param should_highlight boolean? #optional, default value=false should highlight
...
---@param condition function? #optional, default value=true Conditional test. This can either be a function that takes the event context as a single arguments and returns a boolean result, or just the value true to always match when the event is triggered (which is the default value).
...
---@param force_unhighlight boolean? #optional, default value=false Force unhighlight, even if the help_page_link_highlighting ui override is set.
...
---@param show_highlight boolean? #optional, default value=false Show highlight.
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
...
---@param show_highlight boolean? #optional, default value=false Show highlight.
---@param faction_key string? #optional, default value=nil Target faction key. Can be omitted to highlight armies for all factions.
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param dont_highlight_upstream boolean? #optional, default value=false Suppress highlighting of any upstream components if this one is not currently visible.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param first_settlement_only boolean? #optional, default value=false Only highlight buildings for the first settlement on the army panel.
---@param all_but_first_settlement boolean? #optional, default value=false Highlight buildings for all but the first settlement on the army panel.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param reinforcements_only boolean? #optional, default value=false Only highlights reinforcement lords.
...
---@param show_highlight boolean? #optional, default value=false Show highlight.
---@param faction_key string? #optional, default value=nil Target faction key. Can be omitted to highlight ports for all factions.
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param unit_types_only boolean? #optional, default value=false Only highlights the unit type indicator on each card instead of the whole card.
---@param unit_experience_only boolean? #optional, default value=false Only highlights the unit experience indicator on each card instead of the whole card.
---@param unit_banners_only boolean? #optional, default value=false Only highlights unit banners on each card instead of the whole card.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param unit_types_only boolean? #optional, default value=false sets whether this is actually the post-battle panel we are highlighting (campaign_ui_manager:highlight_post_battle_panel_unit_cards sets this flag).
---@param unit_experience_only boolean? #optional, default value=false Only highlights the unit type indicator on each card instead of the whole card.
---@param unit_banners_only boolean? #optional, default value=false Only highlights the unit experience indicator on each card instead of the whole card.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param first_settlement_only boolean? #optional, default value=false Only highlight headers for the first settlement on the army panel.
---@param all_but_first_settlement boolean? #optional, default value=false Highlight headers for all but the first settlement on the army panel.
...
---@param pulse_strength_override number? #optional, default value=nil Pulse Strength Override. Default is 10 for smaller components such as buttons, and 5 for larger components such as panels. Set a higher number for a more pronounced pulsing.
---@param force_highlight boolean? #optional, default value=false Forces the highlight to show even if the help_page_link_highlighting ui override is set.
---@param faction_key string? #optional, default value=nil Target faction key. Can be omitted to highlight settlements for all factions.
