...
---@param advice_key string? #optional, default value=nil Key of advice to deliver alongside the mission.
---@param infotext table? #optional, default value=nil table of string infotext keys to deliver alongside advice.
