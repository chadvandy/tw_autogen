...
---@param highlight_text_key_Highlight_text_key string? #optional, default value=nil may be nil
...
--- Registers a static object by a string name, which can be retrieved later with core:get_static_object. This is intended for use as a registry of global static objects (objects of which there should only be one copy) such as <a href="../battle/battle_manager.html#class:battle_manager">battle_manager, campaign_manager, <a href="../battle/timer_manager.html#class:timer_manager">timer_manager, script_messager, <a href="../battle/generated_battle.html#class:generated_battle">generated_battle and so-on. Scripts that intended to create one of these objects can query the static object registry to see if they've been created before and, if not, can register it.<br />
...
---@param classification string? #optional, default value=nil classification
---@param overwrite boolean? #optional, default value=false overwrite
