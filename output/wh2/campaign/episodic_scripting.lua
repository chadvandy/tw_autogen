...
---@return boolean dlc  flag enabled 
...
--- 
---@param sound_event string Triggers campaign voiceover audio at a character's 3D position. The character specified also partially specifies the path by which the voiceover sound is looked up.
...
---@param command_queue boolean Issue this command via the command queue.
...
---@param use_command_queue boolean Trigger the mission via the command queue or not.
...
---@param faction_key string Faction key, from the factions table.
---@param mission_key string Mission key, from the missions table.
---@param use_command_queue boolean Sends the command via the command queue or not.
...
---@param event string Event feed to block, from the event_feed_events table. Supply a blank string to not filter by event.
...
---@param use_command_queue boolean Sends the declaration command via the command queue.
