...
function intervention:set_disregard_cost_when_triggering(diregard_cost) end
...
function intervention:set_suppress_pause_before_triggering(suppress_pause) end
...
---@param wait_for_events boolean? #optional, default value=true wait for events
function intervention:set_wait_for_event_dismissed(wait_for_events) end
...
---@param duration number? #optional, default value=3 Duration of camera scroll in seconds.
