...
---@param set_all_states boolean? #optional, default value=false Set all states.
...
---@param index image? #optional, default value=0 Index of image associated with this uicomponent to overwrite the path of. This takes precedence over any set "script_icon_index" property.
...
---@param index image? #optional, default value=0 Index of image to return the path of.
...
---@param state_name string? #optional, default value=nil State name. If supplied, this applies the pulsing effect to only the specified state of the uicomponent.
...
---@param state_name string? #optional, default value=nil State name. If supplied, this stops the pulsing effect on only the specified state of the uicomponent.
