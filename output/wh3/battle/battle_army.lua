...
---@param magic_to_add number #magic to add
---@param add_directly boolean? #optional, default value=false add directly
...
---@param reinforcement_collection number? #optional, default value=1 reinforcement collection
...
---@param number_of_messages_allowed_before_disabling_them number? #optional, default value=nil number of messages allowed before disabling them
...
---@param bearing number? #optional, default value=nil Bearing of the special ability in degrees. This is optional and is not required for all abilities.
---@param width number? #optional, default value=nil Width of the special ability in metres. This is optional and is not required for all abilities.
