...
---@param bypass_command_queue boolean? #optional, default value=false Bypasses the command queue. If this is set to true the command is processed immediately, including when paused, but the command will not be reproduced in multiplayer or in a battle replay.
...
---@param focal_depth number? #optional, default value=nil Focus distance.
---@param focal_width number? #optional, default value=nil Focal length.
---@param blur_size number? #optional, default value=nil Blur size.
...
---@param transition_duration number #Transition duration in seconds.
---@param bypass_command_queue boolean? #optional, default value=false Bypass the command queue, initiating the fade immediately.
