...
---@return boolean #contributes to victory 
...
---@param holding_army battle_army? #optional, default value=nil holding army
...
---@return number #contesting alliance id 
