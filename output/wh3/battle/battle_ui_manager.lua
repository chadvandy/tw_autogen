...
---@param pulse_strength number? #optional, default value=nil Override pulse strength
---@param force boolean? #optional, default value=false Enable the highlight even if highlighting has been disabled with battle_ui_manager:set_help_page_link_highlighting_permitted.
---@param highlight_health boolean? #optional, default value=false Only highlight/unhighlight the health bar of unit cards.
---@param highlight_ammo boolean? #optional, default value=false Only highlight/unhighlight the ammunition bar of unit cards.
---@param highlight_xp boolean? #optional, default value=false Only highlight/unhighlight the experience icon of unit cards.
---@param highlight_status boolean? #optional, default value=false Only highlight/unhighlight the status tab of unit cards.
