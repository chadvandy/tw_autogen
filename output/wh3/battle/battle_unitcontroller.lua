...
---@vararg any
function battle_unitcontroller:add_units(units) end
...
---@vararg any
function battle_unitcontroller:add_group(units) end
...
---@param update_ui boolean Update UI with invisibility change. Supply false to not update the UI with this visibility change. This should only be done in very specific circumstances - hiding and showing unit cards can potentially re-order them, so set this flag to false to suppress this behaviour if desired.
...
---@param orientation_in_degrees number orientation in degrees
