...
function global:number_close_to_position(collection_of_units, position, range_in_m) end
...
function global:num_units_in_collection(collection_to_test) end
...
function global:has_deployed(collection_to_test) end
...
function global:ground_type_proportion_in_bounding_box(centre_position, bearing, width, depth, width_samples, depth_samples) end
...
function global:new_sfx(sound_event) end
...
function global:is_shattered_or_dead(collection_to_test, permit_rampaging) end
...
function global:number_alive(collection_to_test) end
...
---@param collection_to_test any Collection to test. Supported collection types are units, scriptunits, army, armies, alliance and table.
function global:num_units_under_fire(collection_to_test) end
...
function global:unitcontroller_from_army(host_army) end
...
function global:num_units_passing_test(collection_to_test, test_function) end
...
function global:is_routing_or_dead(collection_to_test, shattered_only, permit_rampaging) end
...
function global:ground_type_proportion_along_line(start_position, end_position, ground_type, samples) end
...
---@param position vector position
---@param range_in_m number range in m
function global:standing_is_close_to_position(collection_of_units, position, range_in_m) end
...
---@param position vector position
---@param range_in_m number range in m
function global:standing_number_close_to_position(collection_of_units, position, range_in_m) end
...
function global:stop_sound(sound_effect) end
...
---@param shattered_only boolean Only count shattered units
---@param permit_rampaging boolean Don't automatically count rampaging units, check if they are actually routing too.
function global:num_units_routing(collection_to_test, shattered_only, permit_rampaging) end
...
function global:v(x_position, y_position, z_position) end
...
function global:contains_unit(collection_to_test, subject_unit) end
...
function global:distance_between_forces(first_collection, second_collection, number_Closest_distance_in_m_between_forces, obj_Closest_ojbect_from_first_supplied_force, obj_Closest_ojbect_from_second_supplied_force) end
...
function global:v_from_context_str(object_id, constructed_string, function_id) end
...
function global:get_average_altitude(unit_collection) end
...
function global:get_closest_unit(unit_collection, position, additional_test) end
...
function global:get_all_matching_units(collection_to_test, test_function) end
...
function global:is_visible(collection_to_test, alliance) end
...
---@param host_army army host army
---@vararg any
function global:create_unitcontroller(host_army, list_of_units) end
...
function global:rout_all_units(collection_of_units) end
...
---@param collection_to_test any Object or collection to test. Supported objects/collections are units, scriptunits, army, armies, alliance or a table containing any of the above, or units/scriptunits.
---@param permit_rampaging boolean Don't automatically count rampaging units, check if they are actually routing too.
function global:num_units_shattered(collection_to_test, permit_rampaging) end
...
---@param position vector position
---@param range_in_m number range in m
function global:is_close_to_position(collection_of_units, position, range_in_m) end
...
---@param collection_to_test any Collection to test. Supported collection types are units, scriptunits, army, armies, alliance and table.
function global:num_units_engaged(collection_to_test) end
...
---@param position vector position
---@param sound_effect battle_sound_effect sound effect
function global:play_sound(position, sound_effect) end
...
function global:get_closest_standing_unit(unit_collection, position, additional_test) end
