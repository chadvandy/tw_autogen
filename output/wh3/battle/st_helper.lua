...
---@param building_list table #List of buildings to test. This should be an indexed table of battle_building objects, such as (but not restricted to) those returned by functions documented in the Building Lists section of this documentation.
---@param filter_function function? #optional, default value=nil Filter function. This should take a battle_building object as a single argument and return a boolean result. If no filter function is supplied then all buildings pass.
...
---@param partial_match boolean? #optional, default value=false Perform a partial string match. This would allow a supplied capture location search string "major_key_building" to match capture locations with types such as "major_key_building_magic" or "major_key_building_missile".
---@return boolean #capture location of type exists 
...
---@param capture_location_type string? #optional, default value=nil Capture location type, from the capture_point_types database table. If no type is specified then any type is matched.
---@param partial_match boolean? #optional, default value=false Perform a partial string match. This would allow a supplied capture location search string "major_key_building" to match capture locations with types such as "major_key_building_magic" or "major_key_building_missile".
---@return boolean #capture location of type exists 
...
---@param capture_location_type string? #optional, default value=nil Capture location type, from the capture_location_types<\code> database table.
---@param partial_match boolean? #optional, default value=false Perform a partial string match. This would allow a supplied capture location search string "major_key_building" to match capture locations with types such as "major_key_building_magic" or "major_key_building_missile".
...
---@param delta number? #optional, default value=0.1745 horizontal bearing delta in radians. The default value is equivalent to 10 degrees.
...
---@param distance number? #optional, default value=100 Camera-to-target distance in m.
---@param horizontal_bearing number? #optional, default value=0 Horizontal bearing (i.e. looking from above) from camera target to initial camera position in radians.
---@param vertical_bearing number? #optional, default value=0.6175 Vertical vearing (i.e. looking from side) from camera target to initial camera position in radians. The default value is equivalent to 30 degrees.
---@param delta number? #optional, default value=0.1745 Horizontal bearing delta in radians. The default value is equivalent to 10 degrees.
...
---@param vertical_bearing number? #optional, default value=0.6175 Vertical bearing (i.e. looking from side) in radians of the first camera position, from the camera target. The default value is equivalent to 30 degrees.
---@param delta number? #optional, default value=0.1745 Horizontal bearing delta in radians. The default value is equivalent to 10 degrees.
---@return battle_vector #start camera position 
---@return battle_vector
...
---@param distance number? #optional, default value=100 Distance in metres from camera target to computed camera positions.
---@param v_bearing number? #optional, default value=0.6175 Vertical bearing in radians from the camera target to the camera positions, in radians. The default value is equivalent to 30 degrees.
---@param delta number? #optional, default value=0.1745 Horizontal bearing delta in radians. The default value is equivalent to 10 degrees.
---@return battle_vector #start camera position 
---@return battle_vector
...
---@param delta number? #optional, default value=0.6175 Vertical bearing from subject unit to first camera position. The default value is equivalent to 30 degrees.
---@param relaxed_pose number? #optional, default value=nil Horizontal bearing override in radians. By default, the average bearing of all units in the supplied scriptunits collection is used.
---@return battle_vector #camera target 
---@return battle_vector #start camera position 
---@return battle_vector
...
---@param is_attacker boolean? #optional, default value=false Return offset positions as the attacker i.e. from outside the fort.
---@return battle_vector #camera target 
---@return battle_vector #first camera position 
---@return battle_vector #second camera position 
...
---@param camera_positions_generator function? #optional, default value=nil Camera positions generator function. If supplied, this function should return two or three battle_vector objects. If two are supplied, these are assumed to be a camera target and position to pan the camera to when the navigable tour starts.
---@param advice_key string? #optional, default value=nil Key of advice to show when the navigable tour section plays. If nil is supplied then no advice is shown.
---@param infotext table? #optional, default value=nil Table of infotext keys to show when the navigable tour section plays. If nil is supplied then no infotext is shown.
---@param advice_delay number? #optional, default value=1000 Interval before the advice, infotext and objectives begin to display. By default this is 1000ms. A string may also be supplied, in which case it specifies an event which, when received, causes the advice/infotext/objectives to be triggered.
---@param objective string? #optional, default value=nil Objective key of objective to show. This should be a key for a record from the scripted_objectives database table. If nil is supplied then no objective is shown.
---@param objective_test function? #optional, default value=nil Objective completion test function. If supplied, a battle_manager:watch is set up with this function as the condition. When the condition passes, the supplied objective is marked as completed.
---@param leave_objective boolean? #optional, default value=false Leave section objective on-screen after it has been completed. By default the section objective is removed from the screen once it's completed - set this value to true to suppress this behaviour.
---@param windowed_movie_path string? #optional, default value=nil Path of movie to play in window, if one is required for this navigable tour section.
...
---@param suppress_record_camera_position boolean? #optional, default value=false If set to true, the current camera position is not recorded on the scripted tour. This is useful if the scripted tour has already done this.
