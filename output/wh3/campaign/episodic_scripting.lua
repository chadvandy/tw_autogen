...
---@param id string ID for this time trigger
---@param interval number Interval after which to trigger the TimeTrigger event
...
---@param name string Unique name for this composite scene
---@param composite_scene string Composite scene key from the campaign
---@param x number Logical x co
---@param y number Logical y co
---@param facing_x number Logical x co
---@param facing_y number Logical y co
---@param one_shot boolean One shot 
---@param show_in_seen_shroud boolean Sets whether this composite scene should be drawn when in thin shroud over previously
...
---@param faction FACTION_SCRIPT_INTERFACE Faction this composite scene is visible to
...
---@param bonus_value number Bonus value 
