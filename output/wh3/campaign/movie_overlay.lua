...
---@return movie_overlay #movie overlay object 
...
---@param skippable boolean? #optional, default value=true skippable
...
---@param play_audio boolean? #optional, default value=true play audio
...
---@param should_freeze boolean? #optional, default value=true should freeze
...
---@param should_steal boolean? #optional, default value=true should steal
...
---@param stop_audio boolean? #optional, default value=true stop audio
...
---@param duration_override number? #optional, default value=nil duration override
...
---@param ui_root UIC? #optional, default value=ui_root Parent uicomponent, to which the windowed movie player should be attached.
---@return windowed_movie_player #windowed movie player object 
...
---@param show_close_button boolean? #optional, default value=true show close button
