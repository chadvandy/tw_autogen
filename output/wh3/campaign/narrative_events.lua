...
---@param unique_name string #Unique name amongst other declared narrative events.
---@param faction_key string #Key of the faction to which this narrative event applies, from the factions database table.
---@param configuration_callback function? #optional, default value=nil Intervention configuration callback. If supplied, this is passed to narrative_event:add_intervention_configuration_callback to pre-configure the intervention associated with the narrative event prior to it being triggered. The callback will be passed the intervention object as a single argument when called.
---@param trigger_callback function? #optional, default value=nil Trigger callback to call when the intervention is triggered. If supplied, this is passed to narrative_event:set_trigger_callback. The callback will be passed the string triggering message, and a callback which can be used to prevent the narrative event completing immediately. Call the callback with false as an argument to stop it completing, then later with true as an argument to complete.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param start_fade_duration number? #optional, default value=0.5 Duration in seconds over which to fade the picture to black before playing the movie.
---@param end_fade_duration number? #optional, default value=0.5 Duration in seconds over which to fade back to picture after playing the movie.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param cutscene_config function? #optional, default value=nil This function will be called after the cutscene is created and before it is played. It can be used by client scripts to configure the cutscene object and populate it with actions. The function will be passed the cutscene object as a single argument.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param cutscene_config function? #optional, default value=nil This function will be called after the cutscene is created and before it is played. It can be used by client scripts to configure the cutscene object and populate it with actions, if required. The function will be passed the cutscene object as a single argument.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param unique_name string #Unique name amongst other declared narrative events.
---@param faction_key string #Key of the faction to which this narrative event applies, from the factions database table.
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
...
---@param mission_issuer function? #optional, default value=nil A camera scroll callback, to be supplied to narrative_event:set_camera_scroll_target_callback.
---@param mission_rewards string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
...
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
...
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
---@param is_regular_income string? #optional, default value=nil Message to trigger when the mission has completed. This can be a table of strings if multiple on-completed messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param enemy_faction_key string? #optional, default value=nil Key of target enemy faction, from the factions database table. If no key is specified then the capture of any settlement qualifies.
---@param scroll_target string? #optional, default value=nil if multiple target settlements are desired. If no value is supplied then the capture of any settlement qualifies. 
---@param mission_issuer any? #optional, default value=nil Camera scroll target. This can be a string region key, a string faction key (region is looked up before faction), or a number character cqi. If this is supplied the camera will scroll to the specified target when the mission is issued (assuming the narrative event decides to move the camera).
---@param mission_rewards string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param trigger_message table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param inherit_list string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param provinces number? #optional, default value=1 Target number of provinces to control.
---@param province_key string? #optional, default value=nil Key of specific province to control. This may also be a table of string keys if multiple are desired.
---@param scroll_target any? #optional, default value=nil Camera scroll target. This can be a string region key, a string faction key (region is looked up before faction), or a number character cqi. If this is supplied the camera will scroll to the specified target when the mission is issued (assuming the narrative event decides to move the camera).
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param enactments number? #optional, default value=1 Target number of commandments to enact.
---@param commandment_key string? #optional, default value=nil Key of specific commamdment to enact.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param unit_key string? #optional, default value=nil Optional unit key of unit that must be recruited, from the land_units database table. This may also be a table of string unit keys. If a value is supplied here then recruited units only count towards the total if their unit keys match. If no value is supplied then any unit matches.
---@param exclude_existing boolean? #optional, default value=false Excluding pre-existing units from the count.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param building_chain string? #optional, default value=nil Key of building chain the building must be a part of, from the building_chains database table. This may also be a table of string chain keys. If a value is supplied here then the constructed buildings only count towards the total if they belong to a specified chain. If no value is supplied then any constructed building counts towards the total.
---@param exclude_existing boolean? #optional, default value=false Excluding pre-existing buildings from the count.
---@param scroll_target any? #optional, default value=nil Camera scroll target. This can be a string region key, a string faction key (region is looked up before faction), or a number character cqi. If this is supplied the camera will scroll to the specified target when the mission is issued (assuming the narrative event decides to move the camera).
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
...
---@param condition function? #optional, default value=nil Condition function to pass. If no condition function is supplied then the condition always passes.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param condition function? #optional, default value=nil Additional condition function to pass. If a condition is supplied, it will need to be passed in addition to the base "unlocks technologies" requirement.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param additive boolean? #optional, default value=false Sets whether pre-existing technologies count towards the total.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param num_rituals number? #optional, default value=1 Number of rituals to enact. If a value other than 1 is specified then any ritual key is disregarded.
---@param ritual_key string? #optional, default value=nil Key of ritual to enact, from the rituals database table. If no ritual is specified then any ritual counts. This is disregarded if the total is greater than one.
---@param ritual_category_key string? #optional, default value=nil Category key of ritual to enact, from the ritual_categories database table. If no ritual category is specified then any ritual counts.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param num_rituals number? #optional, default value=1 Number of rituals to enact.
---@param ritual_keys string? #optional, default value=nil Key(s) of ritual(s) to enact, from the rituals database table. This can be a string ritual key or a table of strings. If no ritual keys are specified then any rituals match.
---@param ritual_categories string? #optional, default value=nil Key(s) of ritual category/categories to enact, from the ritual_categories database table. This can be a string category key or a table of strings. If no categories are specified then any rituals match.
---@param target_faction_keys string? #optional, default value=nil Key(s) of any target factions, from the factions database table. This can be a string faction key or a table of strings. If no target factions are specified then any targets match.
---@param listen_for_completion boolean? #optional, default value=false Listen for the ritual being completed, rather than the ritual being started.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param advice_key string? #optional, default value=nil Key of advice to issue with this mission, if any, from the advice_threads database table.
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param quantity number? #optional, default value=1 Quantity of plagues to to concoct.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param should_be_allied boolean? #optional, default value=false Should the foreign slot be allied to the owner of the settlement in which it's created to count towards this mission.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param should_be_allied boolean? #optional, default value=nil Should the building be constructed in an allied foreign slot. If false is supplied, the building should be constructed in a non-allied foreign slot. If nil is supplied, a building constructed in any foreign slot will count.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param item_key string? #optional, default value=nil The key of an armory item, from the armory_items database table, that the equipped item must match. This may also be a table of item keys. If nil is supplied then any item equipped by a character in the subject faction will match.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param ability_key string? #optional, default value=nil The key of the ability to perform, from the abilities database table. This may also be a table of ability keys. If nil is supplied then any ability performed will match.
---@param target_faction_key string? #optional, default value=nil The key of the target faction, from the factions database table. This may also be a table of faction keys. If nil is supplied then any faction target will match.
---@param character_subtype string? #optional, default value=nil The subtype key of the performing character, from the agent_subtypes database table. This may also be a table of character subtype keys. If nil is supplied then any performing character will match.
---@param must_be_success boolean? #optional, default value=false If set to true this specifies that the action performed must have had a successful outcome.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param num_symptoms number? #optional, default value=1 The number of symptoms that must be unlocked for the mission to be succeeded.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
...
---@param mission_key string #Key of mission to issue, from the missions database table.
---@param mission_text string #Key of mission text to display, from the mission_text database table. This must be set up for scripted missions such as this.
---@param stance_number number? #optional, default value=1 Stance number, as returned by the stance_adopted() method provided by the ForceAdoptsStance event.
---@param mission_issuer string? #optional, default value="clan_elders" Key of mission issuer, from the mission_issuers database table.
---@param mission_rewards table #Rewards to add to the mission. This should be a table of strings. See the documentation for mission_manager:add_payload for more information on the string formatting and available options.
---@param trigger_message string #Script message on which the narrative event should trigger. This can also be a table of strings if multiple trigger messages are desired.
---@param inherit_list string? #optional, default value=nil Message to trigger when the narrative event has finished issuing. This can be a table of strings if multiple on-issued messages are desired.
