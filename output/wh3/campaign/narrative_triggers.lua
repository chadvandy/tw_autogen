...
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param event_name string #Event name to listen for.
---@param condition function? #optional, default value=nil Condition function to call when the event is received. The event context and narrative trigger objects are provided to the function as arguments. If no condition function is supplied then the condition always passes.
---@param Immediate boolean? #optional, default value=true Trigger the target message(s) immediately when the event is received and the optional condition is met.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel. If multiple messages are required then a table containing string message names can be supplied here instead.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param condition function? #optional, default value=nil Condition function which must be passed for the trigger to fire. This function will be passed the context object from the FactionTurnStart event and the narrative trigger as two separate arguments. It must return a value that evaluates to true for the condition to pass. If no condition function is supplied here then the condition always passes.
---@param faction_starting_turn string? #optional, default value=nil Key of the faction whose turn start we should listen for. If nil is supplied here then the key of the faction to which this narrative trigger applies is used.
---@param Immediate boolean? #optional, default value=true Trigger the target message(s) immediately when the event is received and the optional condition is met.
...
---@param choice_value number? #optional, default value=nil Integer choice value.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param upgrade_available_only boolean? #optional, default value=false The narrative trigger should only fire when a growth point is earned in a player-controlled region and an upgrade of the main settlement chain is available.
---@param province_key string? #optional, default value=nil Key of province in which the growth point must be earned. This can also be a table of string province keys. If left blank, then any growth point earned by the specified faction is counted.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param condition function? #optional, default value=nil Condition function which, if supplied, must be passed in order for the trigger to fire. The condition function is passed the context object supplied by the underlying BuildingConstructionIssuedByPlayer script event as well as the narrative trigger object as separate arguments, and should return a value that evaluates to a boolean. The condition function may also return a second boolean return value, which suppresses downstream output. This can be set if the condition function handles output itself.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param victories number? #optional, default value=1 Threshold number of victories.
---@param condition function? #optional, default value=nil Condition function which, if supplied, must be passed in order for the trigger to fire. The condition function is passed the context object supplied by the underlying BuildingConstructionIssuedByPlayer script event as well as the narrative trigger object as separate arguments, and should return a value that evaluates to a boolean. The condition function may also return a second boolean return value, which suppresses downstream output. This can be set if the condition function handles output itself.
...
---@param less_than boolean? #optional, default value=false Trigger when the pooled resource is less than or equal to the threshold value, rather than greater than.
...
---@param include_armies boolean? #optional, default value=false Includes the target faction's roving armies in the can-reach check, as well as their settlements.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param should_be_allied boolean? #optional, default value=nil Should the foreign slot be allied to the region its embedded in or not. If nil (or no value) is supplied here then the trigger fires in either case.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param ritual_keys string? #optional, default value=nil Key(s) of ritual(s), from the rituals database table. This can be a string ritual key or a table of strings. If no ritual keys are specified then any rituals match.
---@param ritual_categories string? #optional, default value=nil Key(s) of ritual category/categories, from the ritual_categories database table. This can be a string category key or a table of strings. If no categories are specified then any rituals match.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param target_faction_keys string? #optional, default value=nil Key(s) of character ability/abilities, from the abilities database table. This can be a string ability key or a table of strings. If no ability keys are specified then any abilities match.
---@param char_subtypes string? #optional, default value=nil Key(s) of any target factions, from the factions database table. This can be a string faction key or a table of strings. If no target factions are specified then any targets match.
---@param must_be_success string? #optional, default value=nil Key(s) of character subtypes of the performing character, from the agent_subtypes database table. This can be a string subtype key or a table of strings. If no subtypes are specified then any performing characters match.
...
---@param target_message string #Target messages to trigger when this narrative trigger fires. If multiple target messages are required then a table containing string message names can be supplied here instead.
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param technology_key string? #optional, default value=nil Technology key, from the technologies database table, which the subject technology must match for the trigger to fire. A table of string technology keys may be supplied here, in which case the trigger will fire if the subject technology is in the list. Additionally, nil may be specified, in which case any technology matches.
---@param condition function? #optional, default value=nil An additional condition function which, if supplied, must be passed for the trigger to fire. The condition function will be passed the context object from the ResearchStarted event and the narrative trigger as two separate arguments, and should return true if the trigger is allowed to fire.
...
---@param cancel_message string? #optional, default value=nil Message on which this narrative trigger should cancel its main listening process. If multiple messages are required then a table containing string message names can be supplied here instead.
---@param technology_key string? #optional, default value=nil Technology key, from the technologies database table, which the subject technology must match for the trigger to fire. A table of string technology keys may be supplied here, in which case the trigger will fire if the subject technology is in the list. Additionally, nil may be specified, in which case any technology matches.
---@param condition function? #optional, default value=nil An additional condition function which, if supplied, must be passed for the trigger to fire. The condition function will be passed the context object from the ResearchCompleted event and the narrative trigger as two separate arguments, and should return true if the trigger is allowed to fire.
...
---@param trigger_when_lower boolean? #optional, default value=false If set to true, the narrative trigger fires when the net income is less than or equal to the specified threshold instead of greater than or equal to.
