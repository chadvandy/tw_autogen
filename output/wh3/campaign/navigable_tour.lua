...
---@param tour_title string? #optional, default value=nil Full localisation key to use for navigable tour title.
---@return navigable_tour #navigable tour 
...
---@param tour_controls_above_infotext boolean? #optional, default value=true tour controls above infotext
...
---@param should_start_automatically boolean? #optional, default value=true should start automatically
...
---@param action_time number? #optional, default value=0 Interval after the start of the tour at which to trigger the action. This should be given in seconds in campaign, and milliseconds otherwise.
...
---@param do_not_create boolean? #optional, default value=false Do not create - if set to true, the tour controls are not created if they do not already exist.
---@return UIC #tour controls 
...
---@param action_name string? #optional, default value=nil action name
