...
---@param new_force_key string a unique key for this new force
---@vararg any
function random_army_manager:combine_forces(new_force_key, old_force_keys) end
...
---@param Return_as_table number If you have no non-mandatory units specified, this must equal the sum of all mandatory units (since no optional units are available for generating additional units). If unspecified, only the sum of your mandatory units will be spawned.
