...
---@param text_state string? #optional, default value=nil Component state for the first text entry on the topic leader. If nil is supplied then the default state is used.
---@param unlocalised boolean? #optional, default value=false Use the string supplied as the second argument to this function for display directly, instead of using it to look up a localised key. This can be useful for debugging, but shouldn't be used for released content.
---@return topic_leader
...
---@param text_state string? #optional, default value=nil Component state for the text entry. If nil is supplied then the default state is used.
---@param unlocalised boolean? #optional, default value=false Use the string supplied as the first argument to this function for display directly, instead of using it to look up a localised key. This can be useful for debugging, but shouldn't be used for released content.
...
---@param x number? #optional, default value=nil x offset co-ordinate in pixels.
---@param y number? #optional, default value=nil y offset co-ordinate in pixels.
